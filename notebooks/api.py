...
MODEL_PATH      = "models/model_gb_tuned.pkl"
...
def clean_text_for_domain(text: str) -> str:
    return text.lower().strip()

def keyword_overlap(job_clean: str, resume_clean: str) -> int:
    words = job_clean.split()
    resume_words = resume_clean.split()
    return len(set(words) & set(resume_words))

def skill_match(job_clean: str, resume_clean: str) -> int:
    # This is a placeholder for skill matching logic
    return 0

def seniority_score(resume_clean: str) -> int:
    # This is a placeholder for seniority scoring logic
    return 0

def education_score(resume_clean: str) -> int:
    # This is a placeholder for education scoring logic
    return 0
...
MODEL_FEATURES = ["keyword_overlap", "skill_score", "experience_score", "education_score", "domain_match"]
